...
public class ListaDoble{
	...
	public void Imprimir(){ 
		if (VaciaLista()){System.out.println( "vacia" +Nombre);}
		//fin del primer if
		else{
			...
			while (Actual != null)
			{
				System.out.println(Actual.lista.PrimeroDoble.argumento.toString() + " ");
				//System.out.print (Actual.argumento + " ");
	...
	public void InsertaInicio (String r, String a){ 
		if (VaciaLista()) PrimeroDoble = new NodosListaDoble (r,a);
	...
	//Eliminar al Final
	//Debe tomar en cuenta si la lista se encuentra vacia y producir una excepcion, en caso contrario 
	//si PrimerNodo y UltimoNodo referencian al mismo nodo, ambos deben ser null y sino 
	//ultimonodo en el campo siguiente sera nulo
