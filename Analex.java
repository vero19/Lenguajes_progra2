...
public class Analex{
	public static int main (String dato) throws java.io.IOException{
		...
		if(yy.yylex() != 0 || yy.yylex() == 0){
			System.out.println("numero wojeiw");
			return yy.yychar1;}
		return yy.yychar1;
}
	}
...
"12:10,11,12:2,0,12:18,10,12:7,3,4,12:2,8,12,5,12,2:10,7,9,12:5,1:26,12:6,1:" +
"26,12,6,12:3,13:2")[0];
...
"-1,1,12,2,3,4,5,13,6,7,8,9,13,10,-1,1,-1:33,11,-1:8,12,-1:11");
